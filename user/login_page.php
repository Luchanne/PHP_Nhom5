...
<?php
    ...
    if (isset($_POST["submit"])){
        ...
        if (!$name || !$pass){
            ...
            $sql = "SELECT id_kh, ten_kh, matkhau_kh FROM khachhang WHERE ten_kh='$name'";
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">ĐĂNG NHẬP</p>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="#!" class="text-body">Bạn quên mật khẩu?</a>
                    </div>
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        ...
                        <p class="small fw-bold mt-2 pt-1 mb-0">Bạn chưa có tài khoản? <a href="./registration.php"
