...
<form action="" method="post">
    <table align="center" bgcolor="#faebd7">
        <tr>
            <td colspan="2" bgcolor="orange"><h1 style="font-family:cursive;color:red;font-size:45px">Diện tích và chu vi hình tròn</h1></td>
        </tr>
        <tr>
            <td style="font-family:cursive;">Bán Kính</td>
        ...
        <tr>
            <td style="font-family:cursive;">Chu vi</td>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <input type="submit" name="reset" value="Clear" style="font-family:cursive;">
            </td>
        </tr>
    </table>
</form>
