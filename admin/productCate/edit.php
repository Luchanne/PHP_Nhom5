            ...
            <form action="" method="post" enctype="multipart/form-data">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="loaisp" class="form-control"  value="<?php if(isset($_POST['loaisp'])) echo $_POST['loaisp']; else echo $row['ten_lsp']?>" placeholder="Enter ProductType" required>
                </div>
              </div>
